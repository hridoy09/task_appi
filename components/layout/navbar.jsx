    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
            <div className="container _custom_container">
                ...
                <button
                    className="navbar-toggler bg-light border-0 d-flex d-lg-none align-items-center justify-content-center"
                    type="button"
                ...
                <div className={`navbar-collapse${isMenuOpen ? " show" : ""} collapse`} id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        ...
                        <li className="nav-item _header_nav_item">
                            <a className="nav-link _header_nav_link" aria-current="page" href="/feed">
                        ...
                        >
                            <div className="_nav_profile_dropdown_info">
                                ...
                                <div className="_nav_profile_dropdown_info_txt">
                                    ...
                                    <a href="/feed" className="_nav_drop_profile">
                                        View Profile
                                    </a>
                                </div>
                            </div>
